...
### 5. Ghi Nhận Công Bằng & Nhật Ký Thao Tác (Audit Log)

- Theo dõi toàn bộ lịch sử fill form, lưu trữ bằng local storage để trích xuất báo cáo. Có thông báo thưởng tiền "ảo" (+1$ vào tài khoản tác giả / động viên) để tạo động lực làm việc.
